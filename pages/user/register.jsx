        ...
        <Box width={'100%'} h={'10px'}>
            ...
            <Box display={'flex'} justifyContent={'space-between'} height={'100px'}>
                ...
                <Box p={{ base: 10, lg: '90px' }} display={'flex'} flexDirection={'column'} gap={3}>
                    ...
                    <Box>
                        <Heading fontSize={{ base: '40px', lg: '60px' }} color={'#ffff'}>Ro'yxatdan o'tish!</Heading><br />
                    ...
                    <Flex flexDirection={'column'} gap={5}>
                        <FormControl isRequired>
                            ...
                            <Input color={'#000'} value={values.name} onChange={(e) => setValues({ ...values, name: e.target.value })} bg={'#F3F4F6'} type='text' placeholder={'ism...'} h={'50px'} />
                        </FormControl>

                        <FormControl isRequired>
                            <FormLabel>Emailingiz?</FormLabel>
                            <Input color={'#000'} value={values.email} onChange={(e) => setValues({ ...values, email: e.target.value })} bg={'#F3F4F6'} type='email' placeholder={'email...'} h={'50px'} />
                        </FormControl>

                        <FormControl isRequired>
                            <FormLabel>Telefon raqamingiz?</FormLabel>
                            <Input color={'#000'} value={values.phone} onChange={(e) => setValues({ ...values, phone: e.target.value })} ref={inputRef2} bg={'#F3F4F6'} type='text' placeholder={'+998...'} h={'50px'} />
                        </FormControl>
                ...
                <Box display={{ base: 'none', md: 'none', lg: 'block' }}>
                    <Image className='auth_img' src={register} width={'793'} height={'700px'}></Image>
                </Box>
